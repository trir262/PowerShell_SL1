...
if ($ScienceLogic_SL1_dotsourcemodule) { $script:doDotSource = $true }
...
$importIndividualFiles = Get-PSFConfigValue -FullName ScienceLogic_SL1.Import.IndividualFiles -Fallback $false
if ($ScienceLogic_SL1_importIndividualFiles) { $importIndividualFiles = $true }
